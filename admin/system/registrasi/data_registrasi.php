...
<div class="row-fluid">
    <h3 align="center"> 
    Data Registrasi RAKERNAS DAN SEMILOKA TAHUN 2017 
      </h3>
    ...
    <li class="bg_lb span2">   <a href=""><b> peserta semiloka</b> <br> <h1><?php echo $n_semiloka ?></h1>
    </a> </li>
    </ul>
  </div>
        </div>
...
$query2=mysql_query("SELECT registrasi.* , data_peserta.*,data_universitas.* FROM registrasi INNER JOIN data_peserta ON registrasi.no_registrasi=data_peserta.no_registrasi INNER JOIN data_universitas ON registrasi.no_registrasi=data_universitas.no_registrasi");
...
?>
                <tr>
                  ...
                  <a href="index.php?page=edit_data_registrasi&no_regis=<?php echo $data2['no_registrasi']?>" class="btn btn-small btn-warning" title="edit Data Ini"><i class="btn-icon-only icon-pencil"></i></a>

                  <a href="system/registrasi/delete.php?no=<?php echo $data2['no_registrasi']?>" class="btn btn-danger btn-small" title="Hapus Data Ini" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA PENTING INI ... ?')"><i class="btn-icon-only icon-remove"></i></a>
