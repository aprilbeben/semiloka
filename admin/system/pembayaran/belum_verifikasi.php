...
<div class="row-fluid">
    <h3 align="center"> 
    Data Pembayaran belum di verifikasi <br>
 ...
 <tbody>
 <?php 
$query2=mysql_query("SELECT  pembayaran.* ,data_peserta.* FROM pembayaran  INNER JOIN data_peserta ON pembayaran.no_registrasi=data_peserta.no_registrasi WHERE pembayaran.verivikasi='0'");
